...
public class AffichageGraphique {
   ...
   * 
   * @param nbCreation
   *          le nombre de fourmis à créer
   * @return Une ArrayList avec l'ensemble des éléments correspondant aux
   *         fourmis
   */
   ...
   * 
   * @param lesFourmis
   *          La liste des éléments représentant les fourmis
   * @param lesProies
   *          la liste des éléments représentant les proies
   * @param terrain
   *          le terrain sur lequel les éléments évoluent.
   ...
   * 
   * @param fourmis
   *          la liste de d'ojet représentant les fourmis
   * @param proies
   *          la liste d'objet représentant les proies
